...
to ~3. Without a key the validator uses the public archive node; with a failing/expired key
it automatically falls back to the public node per query (issue #151).
